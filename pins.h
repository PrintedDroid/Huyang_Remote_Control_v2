...
// =============================================================================
    ...
    // TFT Display Pins (SPI) - PCB-Sockel: DC=D4, CS_L=D0, CS_R=D8, SCK=D5, MOSI=D7
    #define PIN_TFT_DC        16   // D4
    #define PIN_TFT_CS_LEFT   26   // D0
    #define PIN_TFT_CS_RIGHT  5    // D8
    #define PIN_TFT_RST       -1   // Display-RST liegt auf der PCB an ESP-RST, kein GPIO noetig
    #define PIN_SPI_SCK       18   // D5 (= ESP32 HSPI default)
    #define PIN_SPI_MOSI      23   // D7 (= ESP32 HSPI default)

    // I2C (PCA9685 Servo Shield) - PCB-Sockel: SDA=D2, SCL=D1
    #define PIN_I2C_SDA       21   // D2 (= ESP32 default I2C SDA)
    #define PIN_I2C_SCL       22   // D1 (= ESP32 default I2C SCL)

    // DFPlayer Mini (HardwareSerial on ESP32) - PCB-Sockel: D6 = ESP TX -> DFPlayer RX
    // Keine Rueckleitung auf der PCB verkabelt, daher RX = -1
    #define PIN_AUDIO_TX      19   // D6 -> DFPlayer RX
    #define PIN_AUDIO_RX      -1   // kein Feedback-Kanal

    // NeoPixel Chest Lights - PCB-Sockel: D3
...
// (PCB-Sockel D0..D8 = ESP8266 GPIO 16/5/4/0/2/14/12/13/15)
// =============================================================================
#elif defined(ESP8266)

    // TFT Display Pins (SPI) - PCB-Sockel: DC=D4, CS_L=D0, CS_R=D8
    ...
    #define PIN_TFT_RST       -1   // Display-RST liegt auf der PCB an ESP-RST
                                   // (frueher 0 - kollidierte mit NeoPixel auf D3!)

    // I2C (PCA9685) - PCB-Sockel: SDA=D2, SCL=D1 (= ESP8266 Wire defaults)
    #define PIN_I2C_SDA       4    // D2
    #define PIN_I2C_SCL       5    // D1

    // DFPlayer Mini (SoftwareSerial on ESP8266) - PCB-Sockel: D6 = ESP TX -> DFPlayer RX
    // Keine Rueckleitung auf der PCB, daher RX = -1
    // (frueher RX=12, TX=-1 - falsche Richtung, DFPlayer bekam nie Befehle!)
    #define PIN_AUDIO_TX      12   // D6 -> DFPlayer RX
    #define PIN_AUDIO_RX      -1   // kein Feedback-Kanal

    // NeoPixel Chest Lights - PCB-Sockel: D3
    #define PIN_NEOPIXEL      0    // D3 (Boot-Strap Pin - PCB sollte Pullup haben)
